...
## 更新履歴
ver 1.4.1  写真カテゴリ割り当て機能の調整

ver 1.4.0  過去ログの取り込み機能を追加

ver 1.3.1  Youtube Shortsのサムネ取得に対応

ver 1.3.0  未登録データの手動管理と期間選択機能追加

ver 1.2.1  VRChat側終了時のログ取得安定化

ver 1.2.0  写真表示機能の追加および改善

ver 1.1.6  ログのデータ整合性の向上、他UI調整

ver 1.1.5  設定ファイル周辺データ整合性の改善

ver 1.1.4  exeファイルのパスが変更された際に設定が更新されない問題の修正

ver 1.1.3  環境によってVRChatが起動しない問題を修正
